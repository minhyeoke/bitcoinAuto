...
access = "yga0toCc4JxKJZTRBQznn7XbWULP8zXiKHIej89S"
secret = "G8MAw74aMgRRcbXHxMSZYYxaEGaP4WGzBQQh0Ist"
...
predict_price("KRW-DAWN")
schedule.every().hour.do(lambda: predict_price("KRW-DAWN"))
